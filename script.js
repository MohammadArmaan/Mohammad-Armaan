...
const slider = function(){
  const names = ['Omnifood', 'Roll a Dice', 'Guess My Number', 'Flip a Coin' ,'Chart Genarator', 'Nisal Banking', 'Aihikah Farms', 'QR Code Generator']
  const links = [ 
    ...
    'https://armaanqrcodegenerator.netlify.app/',
